package com.bank.islamic.investmentriskreserve.model;
...
/**
 * The BIAN control record for this service domain: "Investment Risk Reserve Management Plan".
 *
 ...
 * to its asset type (Investment Risk Reserve). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Investment Risk Reserve Management Plan";
